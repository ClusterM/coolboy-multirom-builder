...
namespace com.clusterrr.Famicom.CoolBoy
{
    internal class Config
    {
        ...
        public bool Mindkids { get; private set; } = false;
        ...
        public static void PrintHelp()
        {
            ...
            Console.WriteLine($" {exename} prepare --games <games.txt> --offsets <offsets.json> [--asm <games.asm>] [--saves] [--nosort] [--report <report.txt>] [--maxromsize <size_mb>] [--maxchrsize <size_kb>] [--language <eng|rus>] [--badsectors <sector,sector,...>]");
            ...
            Console.WriteLine($" {exename} combine --loader <menu.nes> --offsets <offsets.json> [--mindkids] [--saves] [--unif <multirom.unf>] [--nes20 multirom.nes] [--bin <multirom.bin>]");
            ...
            Console.WriteLine("  {0,-20}{1}", "--mindkids", "- use MINDKIDS mapper instead of COOLBOY ($5xxx registers)");
            Console.WriteLine("  {0,-20}{1}", "--saves", "- enable flash saving for battery backed games");
            ...
            Console.WriteLine($" {exename} build --games <games.txt> [--asm <games.asm>] [--nesasm <nesasm>] [--nesasm-args <args>] [--sources <path>] [--mindkids] [--saves] [--nosort] [--report <report.txt>] [--maxromsize <size_mb>] [--maxchrsize <size_kb>] [--language <eng|rus>] [--badsectors <sector,sector,...>] [--unif <multirom.unf>] [--nes20 <multirom.nes>] [--bin <multirom.bin>]");
