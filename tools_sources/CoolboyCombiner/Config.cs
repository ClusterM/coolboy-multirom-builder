...
namespace com.clusterrr.Famicom.CoolBoy
{
    internal class Config
    {
        ...
        public static void PrintHelp()
        {
            ...
            Console.WriteLine($" {exename} prepare --games <games.txt> --asm <games.asm> --offsets <offsets.json> [--saves] [--report <report.txt>] [--nosort] [--maxromsize <size_mb>] [--maxchrsize <size_kb>] [--language <eng|rus>] [--badsectors <sectors>]");
            ...
            Console.WriteLine($" {exename} combine --loader <menu.nes> --offsets <offsets.json> [--mindkids] [--unif <multirom.unf>] [--nes20 multirom.nes] [--bin <multirom.bin>]");
            ...
            Console.WriteLine($" {exename} build --games <games.txt> --asm <games.asm> [--nesasm <nesasm>] [--nesasm-args <args>] [--sources <path>] [--mindkids] [--saves] [--report <report.txt>] [--nosort] [--maxromsize <size_mb>] [--maxchrsize <size_kb>] [--language <language>] [--badsectors <sectors>] [--unif <multirom.unf>] [--nes20 <multirom.nes>] [--bin <multirom.bin>]");
